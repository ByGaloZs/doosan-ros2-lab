...
- [ADR 001: Start with `pallet_layout_core`](001-start-with-pallet-layout-core.md)
- [ADR 002: Keep layout core robot-agnostic](002-keep-layout-core-robot-agnostic.md)
- [ADR 003: Use JSON as intermediate format](003-use-json-as-intermediate-format.md)
