...
- `prototypes/`: temporary scripts used to validate an idea or experiment before package implementation.
...
- Do not add executable scripts unless they are needed for a documented task or experiment.
